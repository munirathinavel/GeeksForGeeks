package selfpractice.tusharroy.strings;

/**
 * https://www.youtube.com/watch?v=V-sEwsca1ak
 * Linear time Manacher's algorithm to find longest palindromic substring.
 *
 * Also check Leetcode solutions: leetcode.medium.LongestPalindromicSubstring
 */
public class Manacher_LongestPalindromicSubstring {
    public static void main(String[] args) {
        Manacher_LongestPalindromicSubstring obj = new Manacher_LongestPalindromicSubstring();
